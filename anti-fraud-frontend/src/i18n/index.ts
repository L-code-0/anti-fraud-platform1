...
const messages: Record<Locale, LocaleMessages> = {
  'zh-CN': {
    ...
    deviceCompatibility: {
      ...
      deviceType: '设备类型',
      screen: '屏幕',
      webxrSupport: 'WebXR支持情况',
      webxrSupported: 'WebXR支持',
      immersiveVR: '沉浸式VR',
      immersiveAR: '增强现实',
      inline: '内联模式',
      supported: '支持',
  ...
  'en-US': {
    ...
    deviceCompatibility: {
      ...
      loading: 'Checking device compatibility...',
      deviceInfo: 'Device Information',
      browser: 'Browser',
      os: 'Operating System',
      deviceType: 'Device Type',
      screen: 'Screen',
      webxrSupport: 'WebXR Support',
      webxrSupported: 'WebXR Supported',
      immersiveVR: 'Immersive VR',
      immersiveAR: 'Augmented Reality',
      inline: 'Inline Mode',
      supported: 'Supported',
