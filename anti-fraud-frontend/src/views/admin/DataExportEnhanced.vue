...
const tableData = ref([
  { id: 1, name: '用户数据_2024', category: '用户数据', size: '12.5MB', createTime: '2024-01-15 14:30', status: '正常' },
  { id: 2, name: '知识内容汇总', category: '知识内容', size: '8.2MB', createTime: '2024-01-14 10:20', status: '正常' },
  { id: 3, name: '测试记录_12月', category: '测试记录', size: '25.6MB', createTime: '2024-01-13 16:45', status: '正常' },
  { id: 4, name: '演练统计', category: '演练记录', size: '5.8MB', createTime: '2024-01-12 09:00', status: '正常' },
  { id: 5, name: '举报数据', category: '举报数据', size: '2.1MB', createTime: '2024-01-11 18:30', status: '正常' }
])

const exportHistory = ref([
  { id: 1001, fileName: '用户数据_20240115.xlsx', format: 'xlsx', size: '12.5MB', createTime: '2024-01-15 14:30', status: '成功' },
  { id: 1002, fileName: '学习记录_export.csv', format: 'csv', size: '8.2MB', createTime: '2024-01-14 10:20', status: '成功' },
  { id: 1003, fileName: '测试数据_导出.json', format: 'json', size: '25.6MB', createTime: '2024-01-13 16:45', status: '成功' }
])
