...
const loadData = () => {
  ...
  setTimeout(() => {
    reports.value = [
      { id: 1001, type: 1, typeName: '电话诈骗', title: '疑似冒充公检法诈骗电话', location: '北京市海淀区', status: 2, createTime: '2024-01-15 14:30', progress: 100, attachments: [] },
      { id: 1002, type: 2, typeName: '网络诈骗', title: '虚假购物网站诱导转账', location: '网络', status: 1, createTime: '2024-01-14 10:20', progress: 60, attachments: [] },
      { id: 1003, type: 3, typeName: '短信诈骗', title: '冒充银行积分兑换短信', location: '手机', status: 0, createTime: '2024-01-13 16:45', progress: 10, attachments: [] },
      { id: 1004, type: 2, typeName: '网络诈骗', title: '刷单返利诈骗', location: '网络', status: 2, createTime: '2024-01-12 09:15', progress: 100, attachments: [] },
      { id: 1005, type: 4, typeName: '其他', title: '游戏账号交易诈骗', location: '网络', status: 3, createTime: '2024-01-11 20:30', progress: 0, attachments: [] }
    ]
    warnings.value = [
