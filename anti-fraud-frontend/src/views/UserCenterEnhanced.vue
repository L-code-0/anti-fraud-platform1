...
const recentActivities = ref([
  { id: 1, time: '2024-01-15 14:30', title: '完成测试', description: '高校反诈安全测试 - 得分92分', icon: Edit, color: '#409eff', points: 50 },
  { id: 2, time: '2024-01-15 10:20', title: '学习知识', description: '学习完成《冒充客服诈骗防范》', icon: Reading, color: '#67c23a', points: 20 },
  { id: 3, time: '2024-01-14 16:45', title: '参与演练', description: '完成刷单返利陷阱演练', icon: VideoPlay, color: '#e6a23c', points: 30 },
  { id: 4, time: '2024-01-14 09:00', title: '每日签到', description: '连续签到7天', icon: Clock, color: '#909399', points: 10 }
])
...
const getLearningData = (day: string) => {
  const data: Record<string, { color: string }> = {
    '2024-01-15': { color: '#67c23a' },
    '2024-01-14': { color: '#409eff' },
    '2024-01-13': { color: '#e6a23c' }
  }
  return data[day]
}
